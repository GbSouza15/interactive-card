    ...
    return (
        <>
            <div className='card-back'>
                ...
                <div>
                    <span className='min-[1024px]:absolute min-[1024px]:top-[22.6rem] min-[1024px]:left-[27.8rem] absolute top-[5.8rem] right-[3.5rem] min-[668px]:right-[9rem]'>{setCvc || '000'}</span>
                </div>
            </div>
